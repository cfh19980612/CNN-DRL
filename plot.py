...
plt.plot(x1,y1, type = '-', color = [0.1,0.53,0.93], label = 'FedAVG')
x11,y11 = np.loadtxt('/home/cifar-gcn-drl/Test_data/cifar10_acc_1.csv',delimiter=',',unpack = True)
plt.plot(x11,y11, type = '-', color = [0.75,0.24,1], label = 'DRL')
...
plt.plot(x2,y2, type = '-', color = [0.1,0.53,0.93], label = 'FedAVG')
x21,y21 = np.loadtxt('/home/cifar-gcn-drl/Test_data/cifar10_loss_1.csv',delimiter=',',unpack = True)
plt.plot(x21,y21, type = '-', color = [0.75,0.24,1], label = 'DRL')
